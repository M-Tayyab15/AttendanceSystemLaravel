    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="<?php echo e(url('dashboard')); ?>" class="logo d-flex align-items-center">
                <img src="<?php echo e(asset('assets/img/android-chrome-512x512.png')); ?>" alt="">
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="<?php echo e(asset('assets/img/xolva-img.jpg')); ?>" alt="Profile" class="rounded-circle">
                        <span class="d-none d-md-block dropdown-toggle ps-2">Tayyab Mansoor</span>
                    </a><!-- End Profile Icon -->
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('users-profile')); ?>">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('account-settings')); ?>">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('faq')); ?>">
...
<?php /**PATH F:\AttendanceSystem-3616\resources\views/partials/header.blade.php ENDPATH**/ ?>